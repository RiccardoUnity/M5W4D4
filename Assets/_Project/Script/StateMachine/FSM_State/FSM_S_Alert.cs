...
public class FSM_S_Alert : FSM_BaseState
{
    ...
    public bool IsPathComplete() => _path.status == NavMeshPathStatus.PathComplete;
    ...
    protected override void Start()
    {
        ...
        _transitions[1].SetCondition(0, IsTryToChat, Logic.Equal, true);
        ...
        _transitions[2].SetCondition(0, IsTryToSearch, Logic.Equal, true);
        ...
        _transitions[3].SetCondition(0, IsPathComplete, Logic.Equal, false);
    ...
    private bool IsTryToChat() => _targetInRange && !_fsmController.GetSenseBrain().IsTargetNull();

    private bool IsTryToSearch() => _targetInRange && _fsmController.GetSenseBrain().IsTargetNull();
}
