...
public class FSM_S_Chase : FSM_BaseState
{
    ...
    void Start()
    {
        ...
        _transitions[0] = new FSM_Transition(gameObject, NameState, 2, _fsmController.GetStateByName(GSM.GetStateTake()));
        ...
        _transitions[1] = new FSM_Transition(gameObject, NameState, 2, _fsmController.GetStateByName(GSM.GetStateSearch()));
        ...
        _transitions[2] = new FSM_Transition(gameObject, NameState, 1, _fsmController.GetStateByName(GSM.GetStateCallHelp()));
